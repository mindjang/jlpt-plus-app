  ...
  return (
    ...
    >
      {loading ? (
        ...
        <div className="w-full min-h-screen bg-page relative overflow-hidden">
          <AppBar title="학습 히스토리" onBack={() => router.back()} />

          {/* 배경 장식 그래픽 */}
          <div className="absolute top-24 -left-12 w-64 h-64 pointer-events-none opacity-[0.03] select-none -rotate-12">
            <img
          ...
          <div className="p-4 pb-20 space-y-4 relative z-10">
            {/* 날짜 범위 선택 */}
              ...
              <div className="flex gap-2 bg-surface rounded-lg border border-divider p-2">
                {(['7', '30', '90'] as const).map((range) => (
                  <button
                    ...
                    className={`flex-1 py-2 rounded-lg text-body font-medium ${dateRange === range
