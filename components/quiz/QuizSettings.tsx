    ...
    <Modal isOpen={isOpen} onClose={onClose} title="퀴즈 설정">
      <div className="space-y-6 p-4">
        ...
        <div>
          ...
          <div className="flex items-center justify-center gap-4">
            <button
              ...
              className="w-12 h-12 rounded-full bg-surface border-2 border-divider hover:border-primary disabled:opacity-30 disabled:cursor-not-allowed transition-all flex items-center justify-center"
            >
        ...
        <div>
          ...
          <div className="space-y-2">
            <button
              ...
              className={`w-full px-4 py-2 rounded-card text-body font-medium transition-colors ${
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full py-4 bg-primary text-white rounded-card text-title font-semibold"
        >
          퀴즈 시작
        </motion.button>
      </div>
